...
def main():
    ...
    u_Encoder = Encoder_L1(u2e, embed_dim, uL1paths, ua_list, va_list, u_L1Aggregator, cuda=device, uv=True)
    v_Encoder = Encoder_L1(v2e, embed_dim, vL1paths, ua_list, va_list, v_L1Aggregator, cuda=device, uv=False)
